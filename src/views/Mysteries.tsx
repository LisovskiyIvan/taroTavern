...
export const Mysteries = () => {
  ...
  const fetchData = async () => {
    ...
    if (user) {
      setIsFreeUser(await useFreeTier(user));
    }
    if (isFreeUser) {
  ...
  return (
    <div className="bg-black h-[100dvh] w-[100%] flex flex-col justify-end items-center">
      ...
      <div className="w-[95%] sm:w-[80%] h-[75%] bg-notblack border-rose border-2 rounded-lg p-2 text-rose overflow-y-auto text-lg">
        {data}{" "}
        {loading && (
